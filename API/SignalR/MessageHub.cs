...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IMessageRepository messageRepository, IMapper mapper, IUserRepoLayer userRepoLayer, IHubContext<PresenceHub> presenceHub, PresenceTracker tracker)
        {
            _tracker = tracker;
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var recipient = await _userRepoLayer.GetUserByUsernameAsync(createMessageDto.RecipientUsername);
